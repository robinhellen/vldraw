...
namespace Ldraw.Lego.Nodes
{
	public class CondLineNode : LdrawNode
	{
		...
		public override string FileLine{owned get{return @"5 $(Colour.Code) $(m_A.X) $(m_A.Y) $(m_A.Z) $(m_B.X) $(m_B.Y) $(m_B.Z) $(m_Control1.X) $(m_Control1.Y) $(m_Control1.Z) $(m_Control2.X) $(m_Control2.Y) $(m_Control2.Z)";}}
